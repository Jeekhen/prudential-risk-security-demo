...
print("=" * 70)
print("  INSURANCE RISK & SECURITY DEMO SETUP COMPLETE")
print("=" * 70)
print()
print(f"  Data:  {TABLE_PREFIX}.demo_claims_*  (3 tables)")
print(f"         {TABLE_PREFIX}.demo_security_* (3 tables)")
print()
print(f"  Dashboards:")
